...
def seed_users():
  ...
  demo2 = User(first_name='Natalie', last_name='Brewer',
              username='brewinuptrouble', email='demobrewer@aa.io', password='password123')

  demo3 = User(first_name='Devon', last_name='Duke',
              username='dukexdevon', email='demoduke@aa.io', password='password456')
  ...
  demo6 = User(first_name='Bob', last_name='Miller',
